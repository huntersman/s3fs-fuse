...
static const char help_string[] = 
    ...
    "\n"
    "   disable_update_parent_dir_stat (default is enable)\n"
    "        By default, the mtime and ctime of the parent directory are updated\n"
    "        when a file or directory is created or deleted(when the i-node in\n"
    "        the parent directory is updated).\n"
    "        If this option is specified, this update the parent directory stats\n"
    "        is not updated.\n"
    "\n"
    "FUSE/mount Options:\n"
    "\n"
